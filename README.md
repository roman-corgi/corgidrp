...
## FAQ
  ...
  * Can I create new data classes?
    ...
    * You do not necessarily need to write a copy function for subclasses of 'Image'. If you need to copy calibration objects at all you can import and apply the copy module of python:
      Example: 
      ```
      >import copy
