...
def test_create_flatfield_uranus():
    ...
    onskyflat_field = detector.create_onsky_flatfield(flat_dataset, planet='uranus',band='4',up_radius=55, im_size=420,rad_mask1=1.26, rad_mask4=1.75,  planet_rad=65, n_pix=165, n_pad=302)
