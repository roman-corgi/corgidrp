...
def test_expected_results_e2e(e2edata_path, e2eoutput_path):
    ...
    #ill_dataset, dark_dataset, ill_mean, dark_mean = mocks.create_photon_countable_frames(Nbrights=160, Ndarks=161, cosmic_rate=1, flux=0.5, cic=0.0035075, dark_current=0.00086158) XXX
    ill_dataset, dark_dataset, ill_mean, dark_mean = mocks.create_photon_countable_frames(Nbrights=2, Ndarks=2, cosmic_rate=5, flux=0, cic=0.0088, dark_current=0.001, read_noise=165, EMgain=5000, exptime=80)
