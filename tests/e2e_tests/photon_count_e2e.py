...
def test_expected_results_e2e(tvacdata_path, e2eoutput_path):
    ...
    np.random.seed(1234)
    ill_dataset, dark_dataset, ill_mean, dark_mean = mocks.create_photon_countable_frames(Nbrights=2, Ndarks=3, cosmic_rate=1, flux=0.5)#(Nbrights=160, Ndarks=161, cosmic_rate=1, flux=0.5)
