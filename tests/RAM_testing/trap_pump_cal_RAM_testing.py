...
def test_trap_pump_cal(e2edata_path, e2eoutput_path):
    ...
    # for file in os.listdir(trap_pump_datadir):
    #     if not file.endswith('.fits'):
    #         continue
    #     with fits.open(os.path.join(trap_pump_datadir, file), mode='update') as fits_file:
    #     prihdr = fits_file[0].header
    #     exthdr = fits_file[1].header
    #     prihdr['VISTYPE'] = 'CGIVST_CAL_TPUMP'
...
if __name__ == "__main__":
    ...
    # making e2e simulated data, which is ENG and includes nonlinearity
