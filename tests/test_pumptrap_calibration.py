...
def test_tpump_analysis():
    ...
    generate_mock_pump_trap_data(test_data_dir, metadata_file, e2emode=True, nonlin_path=None, EMgain=2, read_noise=100)
    ...
    length_lim = 5
    tau_fit_thresh = .5#0.8#0.65 #0.8
    cs_fit_thresh = .5#0.8# 0.2 #0.65 #0.8#0.65 #0.8
    thresh_factor = 1.5 #.5
    ill_corr = True
    tfit_const = True
    input_T = 185
