...
def test_expected_results_sub():
    ...
    assert(noise_maps.ext_hdr["BUNIT"] == "Photoelectrons")
    assert(noise_maps.err_hdr["BUNIT"] == "Photoelectrons")
    ...
    assert(nm_open.ext_hdr["BUNIT"] == "Photoelectrons")
    assert(nm_open.err_hdr["BUNIT"] == "Photoelectrons")
