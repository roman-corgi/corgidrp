...
# Load dictionary of anticipated bright and dim CASLPEC standard star names
CALSPEC_CONFIG_FILE = os.path.join(os.path.dirname(corgidrp.__file__), 'data','calspec_config.toml')
with open(CALSPEC_CONFIG_FILE, 'rb') as f:
    CALSPEC_DICT = tomllib.load(f)
calspec_names = CALSPEC_DICT['stars']
calspec_url = CALSPEC_DICT['url']
