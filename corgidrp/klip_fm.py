...
def measure_noise(frame, seps_pix, halfwidth, klmode_index=None):
    ...
    Args:
        ...
        halfwidth (float): halfwidth of the annulus to use for noise calculation.
    ...
    for sep_pix in seps_pix:
        r_inner = sep_pix - halfwidth
        r_outer = sep_pix + halfwidth
