...
Image HDU array: (4,r,c), where r and c depend on cropping.
ERR HDU array: (1,4,r,c)
DQ HDU array: (4,r,c)
...
| 0     | Primary          | None     | 0                    |
+-------+------------------+----------+----------------------+
| 1     | Image            | float32  | (4, 54, 54)          |
+-------+------------------+----------+----------------------+
| 2     | ERR              | float32  | (1, 4, 54, 54)       |
+-------+------------------+----------+----------------------+
| 3     | DQ               | uint16   | (4, 54, 54)          |
+-------+------------------+----------+----------------------+
| 4     | KL_THRU          | float32  | (2, 2, 2)            |
+-------+------------------+----------+----------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| FILETIME   | str        | 2026-02-20T06:41:40.140828+... | When file was created                                                                                                    |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| TARGET     | str        | ScienceStar                    | Name of pointing target                                                                                                  |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| SCTSRT     | str        | 2026-05-05T17:39:18            | Spacecraft timestamp of first packet for this image frame in UTC                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| SCTEND     | str        | 2026-05-05T17:40:18            | Spacecraft timestamp of last packet for this image frame in UTC                                                          |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| RECIPE     | str        | {"name": "l3_to_l4_pol", "t... | DRP recipe and steps; paths to noise maps, calib                                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NRECIPES   | int        | 1                              | Number of recipes recorded                                                                                               |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| DRPVERSN   | str        | 3.1                            | corgidrp version that produced this file                                                                                 |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| DRPCTIME   | str        | 2026-02-20T06:41:40.326        | When this file was saved                                                                                                 |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CD1_1      | float      | 0.848048096156426              | WCS: transform matrix element axis 1 (deg/pixel)                                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CD1_2      | float      | 0.5299192642332049             | WCS: matrix elem mixing axis 2 into 1 (deg/pixel)                                                                        |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CD2_1      | float      | -0.5299192642332049            | WCS: matrix elem mixing axis 1 into 2 (deg/pixel)                                                                        |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CD2_2      | float      | 0.848048096156426              | WCS: transform matrix element axis 2 (deg/pixel)                                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CRPIX1     | float      | 28.0                           | WCS: reference pixel position axis 1 (pixel)                                                                             |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CRPIX2     | float      | 28.0                           | WCS: reference pixel position axis 2 (pixel)                                                                             |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CTYPE1     | str        | RA---TAN                       | WCS: coordinate type axis 1 (e.g. RA---TAN)                                                                              |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CTYPE2     | str        | DEC--TAN                       | WCS: coordinate type axis 2 (e.g. DEC--TAN)                                                                              |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CDELT1     | float      | 0.0                            | WCS: pixel scale axis 1; deprecated if CD matrix                                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CDELT2     | float      | 0.0                            | WCS: pixel scale axis 2; deprecated if CD matrix                                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NORTHANG   | float      | -17.0                          | WCS: northang calculated from northangle of astrom cal and roll_offset between image frame and astrom cal frame (deg)    |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| STARLOCX   | float      | 27.0                           | X (column) position of the target star in the image (pixels)                                                             |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| STARLOCY   | float      | 27.0                           | Y (row) position of the target star in the image (pixels)                                                                |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| DRPNFILE   | int        | 1                              | Num raw files used in pyKLIP                                                                                             |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| FILE_0     | str        | _INT1.fits                     | Name of file used in PYKLIP                                                                                              |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CTYPE3     | str        | STOKES                         | Flag indicating this is a polarimetry/ Stokes cube                                                                       |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CTCALFN    | str        | cgi_0200001001001001001_202... | Core throughput calibration file name                                                                                    |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| FLXCLF0   | str        | cgi_0200001001001001001_202... | POL0 flux calibration file name                                                                                          |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| FLXCLF45   | str        | cgi_0200001001001001001_202... | POL45 flux calibration file name                                                                                         |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| HISTORY    | str        | Marked 0 frames as bad:  I...  | Processing history                                                                                                       |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
| DESMEAR    | bool       | False                          | Desmearing used in L1→L2a pipeline (0/1)                                                                                 |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| HISTORY    | str        | Interpolated over 0 bad pi...  | Processing history                                                                                                       |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
