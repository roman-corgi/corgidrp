...
| 0     | Primary          | None     | 0                    |
+-------+------------------+----------+----------------------+
| 1     | Image            | float32  | (2, 51)              |
+-------+------------------+----------+----------------------+
| 2     | ERR              | float32  | (1, 2, 51)           |
+-------+------------------+----------+----------------------+
| 3     | DQ               | uint16   | (2, 51)              |
+-------+------------------+----------+----------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| VISTYPE    | str        | CGIVST_CAL_ABSFLUX_FAINT       | The visit file template used for this observation                                                                        |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| TARGET     | str        | tyc 4424-1286-1                | Name of pointing target (CALSPEC standard star used for flux calibration)                                                |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NAXIS1     | int        | 51                             | Raw data axis 1 size (number of spectral bins)                                                                           |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NAXIS2     | int        | 2                              | Raw data axis 2 size (row 0 = wavelength, row 1 = spectral flux calibration)                                             |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| FPAMNAME   | str        | OPEN_34                        | Closest named FPAM position; OPEN_34 = no ND filter (dim-star flux cal frames)                                           |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| CFAMNAME   | str        | 3F                             | Closest named CFAM position; 3F = Band 3 broadband filter                                                                |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| WV0_X      | float      | 513.013                        | X pixel coordinate of wavelength zero-point source (broadband filter frame)                                              |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| WV0_XERR   | float      | 0.003                          | Uncertainty in X pixel coordinate of wavelength zero-point                                                               |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| WV0_Y      | float      | 503.410                        | Y pixel coordinate of wavelength zero-point source (broadband filter frame)                                              |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| WV0_YERR   | float      | 0.005                          | Uncertainty in Y pixel coordinate of wavelength zero-point                                                               |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| DATATYPE   | str        | SpecFluxCal                    | Calibration data type                                                                                                    |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| HISTORY    | str        | spectral flux calibration wa.. | Processing history                                                                                                       |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
| NAXIS1     | int        | 51                             | Raw data axis 1 size (number of spectral bins)                                                                           |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NAXIS2     | int        | 2                              | Raw data axis 2 size (row 0 = wavelength err, row 1 = spectral flux calibration err)                                     |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
| NAXIS1     | int        | 51                             | Raw data axis 1 size (number of spectral bins)                                                                           |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NAXIS2     | int        | 2                              | Raw data axis 2 size                                                                                                     |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| PCOUNT     | int        | 0                              | number of parameters                                                                                                     |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| GCOUNT     | int        | 1                              | number of groups                                                                                                         |
