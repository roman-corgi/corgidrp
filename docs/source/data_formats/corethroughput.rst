...
| 0     | Primary          | None     | 0                    |
+-------+------------------+----------+----------------------+
| 1     | Image            | float32  | (9, 15, 15)          |
+-------+------------------+----------+----------------------+
| 2     | ERR              | float32  | (1, 9, 15, 15)       |
+-------+------------------+----------+----------------------+
| 3     | DQ               | uint16   | (9, 15, 15)          |
+-------+------------------+----------+----------------------+
| 4     | CTEXCAM          | float32  | (3, 9)               |
+-------+------------------+----------+----------------------+
| 5     | CTFPAM           | float32  | (2,)                 |
+-------+------------------+----------+----------------------+
| 6     | CTFSAM           | float32  | (2,)                 |
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NAXIS3     | int        | 9                              | Length of third array dimension (axis 3)                                                                                 |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
...
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| NAXIS1     | int        | 9                              | Raw data axis 1 size                                                                                                     |
+------------+------------+--------------------------------+--------------------------------------------------------------------------------------------------------------------------+
